            ...
            <div class="container">
                <div class="row">
                    <div class="page-head-content">
                        <h1 class="page-title">음료 정보 수정</h1>               
                    </div>
                </div>
            </div>
        </div>
...
<h2>수정할 음료 : ${ drink.dk_name } </h2>
	...
	<input type="hidden" name="dk_name" value="${ drink.dk_name }" />
		...
		<hr>
		<br>Feature 3 <br>
						이전 선택 : ${drink.dk_f3 } <br><hr>
		
		 <input type="radio" id="water"
			name="dk_f3" value="water"> water <br> <input
			type="radio" id="milk" name="dk_f3" value="milke"> milk <br>
		<hr>
		<br>Feature 4 <br> 
						이전 선택 : ${drink.dk_f4 } <br><hr>
