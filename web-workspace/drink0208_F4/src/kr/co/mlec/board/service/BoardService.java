...
//????	BoardVO board = boardDao.selectgroupNo(board);//num tilte write 다 들어있어서 boardNo 가져옴
		int boardNo = boardDao.selectBoardNo();// num tilte write 다 들어있어서 boardNo 가져옴
		...
		System.out.println("service board 답글등록서비스 : " + board);
		System.out.println("service board 답글등록서비스 그룹넘버 : " + groupNo);
		
		System.out.println("service board 답글등록서비스 re넘버 : " + reNo);
